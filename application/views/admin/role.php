                    ...
                    <?php foreach ($role as $r) : ?>
                        <tr>
                            ...
                            <td>
                               ...
                               <a href="#" class="btn btn-success" data-toggle="modal" data-popup="tooltip"
                               data-placement="top" title="edit" data-target="#roleedit<?= $r['id'] ?>">Edit</a>
                               <button onclick="deleteRole('<?= base_url('admin/deleterole/') . $r['id'] ?>')" class="btn btn-danger btn-sm tombol-delete">Delete</button>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
